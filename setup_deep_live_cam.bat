...
:: 2. Clone Repository
@REM if exist Deep-Live-Cam (
@REM     echo Deep-Live-Cam directory already exists.
@REM     set /p overwrite="Do you want to overwrite? (Y/N): "
@REM     if /i "%overwrite%"=="Y" (
@REM         rmdir /s /q Deep-Live-Cam
@REM         git clone https://github.com/hacksider/Deep-Live-Cam.git
@REM     ) else (
